...
export const title = 'دیتاگیت';
export const tagline = 'برای برنامه نویس شدن باید دست به کد شد!';
export const url = 'https://datagit.ir';
export const baseUrl = '/';
export const trailingSlash = false;
export const organizationName = 'massoudmaboudi';
export const projectName = 'datagit';
